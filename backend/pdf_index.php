...
<script>
    ...
    async function generateChartBySessionAndSlot(sessionid,slots){
        $link = 'https://www.moodle.local/mod/activequiz/backend/api/chart_api.php?sessionid=11&type=bar&slot='.slots;
        console.log($link)
