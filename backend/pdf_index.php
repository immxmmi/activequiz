...
<script>
    ...
    async function generateChartBySessionAndSlot(sessionid,slot2){
        $link = 'https://www.moodle.local/mod/activequiz/backend/api/chart_api.php?sessionid=11&type=bar&slot='.$slot2;
        console.log($link)
