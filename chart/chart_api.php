<?php
    ...
    require_once("../backend/class/mdl_activequiz_sessions.php");
    require_once("../backend/class/mdl_activequiz_attempt.php");
    require_once("../backend/class/mdl_question_attempts.php");
    require_once("../backend/class/mdl_question_attempt_steps.php");
    require_once("../backend/class/mdl_question_attempt_step_data.php");
    require_once("../backend/class/single_choice.php");
    require_once("../backend/class/truefalsechoice.php");
    global $DB;
